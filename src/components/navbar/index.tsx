    ...
    <header className="header" style={{ background: "#fff" }}>
      <div className="main-header">
        <div className="container">
          <nav
            className="navbar navbar-expand-lg navbar-light justify-content-center align-items-center"
            style={{ padding: "0px !important" }}
          >
            <a className="navbar-brand" href="./index.html">
              <figure className="mb-0 banner-logo">
                <img src="./assets/images/logo.svg" alt="" width="200" className="img-fluid" />
              </figure>
            </a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav">
                <li className={activeNav === "home" ? "nav-item active" : "nav-item"}>
                  <Link to="/" className="nav-link navbar-text-color">
                    Home
                  </Link>
                </li>
                ...
                >
                  <Link
                    to="/app"
                    className="nav-link dropdown-toggle dropdown-color navbar-text-color app_nav"
                  ...
                  <div className="dropdown-menu drop-down-content app_nav_content">
                    <ul className="list-unstyled drop-down-pages">
                      <li className="nav-item">
                        <Link to="/app/1" className="dropdown-item nav-link">
                          Retail 360°
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link to="/app/2" className="dropdown-item nav-link">
                          Food Beverage 360°
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link to="/app/3" className="dropdown-item nav-link">
                          Healthcare 360°
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link to="/app/4" className="dropdown-item nav-link">
                          Manufacturing 360°
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link to="/app/5" className="dropdown-item nav-link">
                          Entertainment 360°
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link to="/app/6" className="dropdown-item nav-link">
                          HR 360°
                        </Link>
                      </li>
                    </ul>
