              ...
              <div className="icons ml-4">
                <div className="lower-content">
                  ...
                  <div className="content">
                    ...
                    <Link to="/" className="text-size-18 mb-0 text text-decoration-none h5"  style={{color: "#000"}}>
                        +91 95914 33122
                    </Link>
                  </div>
                </div>
                <div className="lower-content mt-4">
                  ...
                  <div className="content">
                    ...
                    <Link to="/" className="text-size-18 mb-0 text-decoration-none h5" style={{color: "#000"}}>
                        indiahr@gwcdata.ai
                    </Link>
                  </div>
                </div>
