                ...
                <div className="blog_boxcontent">
                  <div className="lower_portion_wrapper">
                    ...
                    <div className="lower_portion">
                      <h4>Diversity and Inclusion Dashboard</h4>
                      <p className="text-size-18">
                      Track diversity initiatives and measure progress towards inclusion goals.
                      </p>
              ...
              <div className="item">
                <div className="blog_boxcontent">
                  <div className="lower_portion_wrapper">
                    ...
                    <div className="lower_portion">
                      <h4>Employee Satisfaction Dashboard</h4>
                      <p className="text-size-18">
                      Gauge overall employee satisfaction and identify areas for improvement.
                      </p>
                      <ul className="list-unstyled mb-0">
                        <li className="text text-size-18">
                          <i className="fa-solid fa-circle-check mr-2" style={{ color: "#7a3ca3"}}></i>
