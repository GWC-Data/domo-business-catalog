  ...
  return (
    <div className="container mt-5">
      <div>
        ...
        <p>Maintain product excellence by monitoring quality metrics and driving continuous improvement.</p>
      </div>
              ...
              <div className="item">
                <div className="blog_boxcontent mb-0">
                  <div className="lower_portion_wrapper">
                    ...
                    <div className="lower_portion">
                      <h4>First Pass Yield (FPY)</h4>
                      <p className="text-size-18">Maximize first-pass success rates to reduce rework and improve efficiency.</p>
                      <ul className="list-unstyled mb-0">
                        <li className="text text-size-18">
                          <i className="fa-solid fa-circle-check mr-2" style={{ color: "7a3ca3"}}></i>
